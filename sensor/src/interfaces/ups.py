...
class UPSInterface:
    def __init__(self, config: types.Config):
        ...
        mode_input = gpiozero.DigitalInputDevice(Constants.ups.pin_battery_mode_in, bounce_time=300)
        ...
        alarm_input = gpiozero.DigitalInputDevice(Constants.ups.pin_alarm_in, bounce_time=300)
        ...
        ready_input = gpiozero.DigitalInputDevice(Constants.ups.pin_ready_in, bounce_time=2000)
