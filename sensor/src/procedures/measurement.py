            ...
            self.message_queue.enqueue_message(
                ...
                custom_types.MQTTDataMessageBody(
                    ...
                    value=custom_types.MQTTWindData(
                        direction_min =  wind_data.direction_min,
                        direction_avg = wind_data.direction_avg,
                        direction_max = wind_data.direction_max,
                        speed_min =  wind_data.speed_min,
                        speed_avg = wind_data.speed_avg,
                        speed_max = wind_data.speed_max,
                        last_update_time = wind_data.last_update_time,
                    ),
                ),
            )
